...
public class BatchConfiguration {
	...
	private static String[] FIELD_DATA = { "id", "city", "date", "player_of_match", "venue", "neutral_venue", "team1",
	...
	public FlatFileItemReader<MatchInput> reader() {
		return new FlatFileItemReaderBuilder<MatchInput>().name("personItemReader")
				.resource(new ClassPathResource("IPL_DATA.csv")).delimited().names(FIELD_DATA)
	...
	@Bean
	public MatchInputprocessing processor() {
		return new MatchInputprocessing();
	}
